...
public class Modelcustom_model<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("mario_mod", "modelcustom_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rightFoot = partdefinition.addOrReplaceChild("rightFoot",
				CubeListBuilder.create().texOffs(24, 7).addBox(-5.0F, -4.0F, -5.0F, 4.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 41)
		...
		PartDefinition leftFoot = partdefinition.addOrReplaceChild("leftFoot",
				CubeListBuilder.create().texOffs(0, 22).addBox(-5.0F, -4.0F, -3.0F, 4.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(35, 40)
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.75F));
		PartDefinition cube_r1 = body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(47, 40).addBox(-0.5F, -1.75F, -2.25F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -13.1957F, 9.5093F, 1.2217F, 0.0F, 0.0F));
		PartDefinition cube_r2 = body.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(12, 41).addBox(-1.0F, -2.35F, -2.6F, 2.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -10.1456F, 8.5455F, 0.829F, 0.0F, 0.0F));
		PartDefinition cube_r3 = body.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(37, 22).addBox(-2.0F, -4.0F, -2.5F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -6.4965F, 6.2686F, 0.3927F, 0.0F, 0.0F));
		PartDefinition cube_r4 = body.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(38, 0).addBox(-3.0F, -1.0F, -3.0F, 6.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -14.8363F, -1.9393F, -1.8762F, 0.0F, 0.0F));
		PartDefinition cube_r5 = body.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 32).addBox(-3.0F, -1.5F, -2.0F, 6.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -14.8363F, -1.9393F, -1.5708F, 0.0F, 0.0F));
		PartDefinition cube_r6 = body.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 13).addBox(-4.0F, -4.0F, -1.75F, 8.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -12.262F, -3.4919F, -1.3526F, 0.0F, 0.0F));
		PartDefinition cube_r7 = body.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(38, 32).addBox(-3.0F, -3.75F, 0.0F, 6.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -10.6957F, -2.8927F, -0.7418F, 0.0F, 0.0F));
		PartDefinition cube_r8 = body.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(19, 17).addBox(-3.0F, -3.25F, -2.5F, 6.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -8.0F, 1.5F, -0.3054F, 0.0F, 0.0F));
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -24.25F, -4.0F, 9.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(19, 26)
		...
		PartDefinition eyes = partdefinition.addOrReplaceChild("eyes",
				CubeListBuilder.create().texOffs(20, 35).addBox(-3.0F, -29.25F, -2.0F, 6.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition leftArm = partdefinition.addOrReplaceChild("leftArm", CubeListBuilder.create(), PartPose.offset(6.689F, 12.2256F, -1.2287F));
		PartDefinition cube_r9 = leftArm.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(0, 0).addBox(0.3005F, 0.2496F, 0.289F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = leftArm.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(0, 3).addBox(-1.639F, -0.7194F, 0.7563F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r11 = leftArm.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(0, 22).addBox(-1.5746F, 0.2496F, 0.211F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = leftArm.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(14, 24).addBox(-0.5971F, 0.2496F, -0.0757F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r13 = leftArm.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(24, 0).addBox(-1.2192F, -0.7504F, -3.9731F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r14 = leftArm.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(0, 13).addBox(1.0F, -1.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(38, 8)
		...
		PartDefinition cube_r15 = rightArm.addOrReplaceChild(
				...
				PartPose.offsetAndRotation(-0.8789F, 0.6582F, -0.7064F, 0.2376F, 0.9787F, 2.4918F));
		PartDefinition cube_r16 = rightArm.addOrReplaceChild(
				"cube_r16", CubeListBuilder.create().texOffs(0, 3).mirror()
						.addBox(0.639F, -0.7194F, 0.7563F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-0.8789F, 0.6582F, -0.7064F, -3.0692F, 0.7345F, -1.2433F));
		PartDefinition cube_r17 = rightArm.addOrReplaceChild(
				"cube_r17", CubeListBuilder.create().texOffs(0, 22).mirror()
						.addBox(0.5746F, 0.2496F, 0.211F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-0.8789F, 0.6582F, -0.7064F, 2.7992F, 1.1687F, -1.1651F));
		PartDefinition cube_r18 = rightArm.addOrReplaceChild(
				"cube_r18", CubeListBuilder.create().texOffs(14, 24).mirror()
						.addBox(-0.4029F, 0.2496F, -0.0757F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-0.8789F, 0.6582F, -0.7064F, 0.9301F, 1.4062F, -3.0662F));
		PartDefinition cube_r19 = rightArm.addOrReplaceChild(
				"cube_r19", CubeListBuilder.create().texOffs(24, 0).mirror()
						.addBox(-0.7808F, -0.7504F, -3.9731F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-0.8789F, 0.6582F, -0.7064F, 1.8071F, 1.4352F, -2.1806F));
		PartDefinition cube_r20 = rightArm.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(0, 13).mirror().addBox(-2.0F, -1.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(38, 8).mirror().addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(2.689F, -2.2256F, -0.7713F, -1.7017F, 0.0F, 0.0F));
		PartDefinition saddle = partdefinition.addOrReplaceChild("saddle",
				CubeListBuilder.create().texOffs(8, 48).addBox(-2.0F, -13.25F, 3.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
