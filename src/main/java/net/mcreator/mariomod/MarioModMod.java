...
@Mod("mario_mod")
public class MarioModMod {
	public static final Logger LOGGER = LogManager.getLogger(MarioModMod.class);
	public static final String MODID = "mario_mod";
