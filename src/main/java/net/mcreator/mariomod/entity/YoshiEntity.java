...
public class YoshiEntity extends PathfinderMob {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(MarioModModEntities.YOSHI.get(), 20, 4, 4));
	}

	public YoshiEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MarioModModEntities.YOSHI.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(MarioModModEntities.YOSHI.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
