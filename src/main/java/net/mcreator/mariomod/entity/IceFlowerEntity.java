...
public class IceFlowerEntity extends AbstractArrow implements ItemSupplier {
	public IceFlowerEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(MarioModModEntities.ICE_FLOWER.get(), world);
	}
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		IceFlowerProjectileHitsLivingEntityProcedure.execute(entityHitResult.getEntity());
	}
	...
	public static IceFlowerEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		IceFlowerEntity entityarrow = new IceFlowerEntity(MarioModModEntities.ICE_FLOWER.get(), entity, world);
	...
	public static IceFlowerEntity shoot(LivingEntity entity, LivingEntity target) {
		IceFlowerEntity entityarrow = new IceFlowerEntity(MarioModModEntities.ICE_FLOWER.get(), entity, entity.level);
