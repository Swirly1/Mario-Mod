...
public class ModelkoopaShell<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "koopashell"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(26, 27)
						.addBox(-5.0F, -2.0F, -8.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(18, 14)
		...
		PartDefinition cube_r1 = bb_main
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(18, 4).addBox(2.0F, -17.0F, -4.0F, 1.0F, 1.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(1.0F, 8.0F, -1.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r2 = bb_main.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(18, 7)
						.addBox(-3.0F, -23.0F, 4.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						...
						.addBox(-5.0F, -21.0F, 6.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(36, 12)
						.addBox(-6.0F, -21.0F, 3.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, 15.0F, -1.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r3 = bb_main.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(22, 35).addBox(-7.0F, -23.0F, 7.0F, 1.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0F, 18.0F, -1.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r4 = bb_main
				.addOrReplaceChild("cube_r4",
						CubeListBuilder.create().texOffs(0, 41).addBox(-12.0F, -23.0F, -6.0F, 1.0F, 1.0F, 4.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = bb_main.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(6, 42)
						.addBox(-6.0F, -21.0F, 3.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(8, 11)
						...
						.addBox(-3.0F, -23.0F, 4.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 3)
						.addBox(-4.0F, -23.0F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, 15.0F, 1.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r6 = bb_main.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(18, 11).addBox(2.0F, -17.0F, -4.0F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, 8.0F, 1.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r7 = bb_main.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(16, 42).addBox(-12.0F, -23.0F, -6.0F, 1.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, 18.0F, 1.0F, -3.1416F, 0.0F, 3.1416F));

		PartDefinition cube_r8 = bb_main.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(36, 0).addBox(-7.0F, -23.0F, 7.0F, 1.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, 18.0F, 1.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r9 = bb_main.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(26, 42).addBox(-12.0F, -23.0F, -6.0F, 1.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 18.0F, 4.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r10 = bb_main.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(36, 6).addBox(-7.0F, -23.0F, 7.0F, 1.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r11 = bb_main.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(8, 21)
						.addBox(-5.0F, -21.0F, 6.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(42, 28)
		...
		PartDefinition cube_r14 = bb_main.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(0, 31)
						...
						.addBox(3.0F, -16.0F, -3.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(18, 7)
						.addBox(2.0F, -17.0F, -3.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r15 = bb_main.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(36, 24)
						.addBox(7.0F, -13.0F, -2.0F, 1.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(43, 18)
						...
						.addBox(4.0F, -16.0F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(6, 47)
						.addBox(-3.0F, -17.0F, -2.0F, 7.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r16 = bb_main.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(38, 38)
						.addBox(7.0F, -13.0F, -2.0F, 1.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(44, 35)
						...
						.addBox(4.0F, -16.0F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(38, 46)
						.addBox(3.0F, -17.0F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 8.0F, 0.0F, 0.0F, 1.5708F, 0.0F));
