	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = leftLeg.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(6, 2)
						.addBox(-3.0F, -2.0F, -5.0F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(7, 1)
						...
						.addBox(-5.0F, -2.0F, -5.0F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(12, 28)
						.addBox(-6.0F, -2.0F, -5.0F, 1.0F, 0.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r2 = leftLeg.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-7.0F, 0.0F, -2.0F, 1.0F, 0.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(27, 11)
		...
		PartDefinition cube_r3 = leftLeg.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 2)
						.addBox(3.0F, -2.0F, -6.0F, 0.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r4 = leftLeg
				.addOrReplaceChild("cube_r4",
						CubeListBuilder.create().texOffs(0, 17).addBox(6.0F, -2.0F, -8.0F, 0.0F, 2.0F, 11.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.0F));

		PartDefinition rightleg = partdefinition.addOrReplaceChild("rightleg",
				CubeListBuilder.create().texOffs(8, 10)
						.addBox(-3.0F, -1.0F, -5.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(6, 8)
		...
		PartDefinition cube_r6 = rightleg.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 19).addBox(6.0F, -2.0F, -3.0F, 0.0F, 2.0F, 11.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = rightleg.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(24, 0)
						.addBox(-6.0F, 0.0F, -8.0F, 3.0F, 0.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(20, 11)
		...
		PartDefinition cube_r8 = body.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(0, 11).addBox(-5.0F, -9.0F, -2.0F, 10.0F, 8.0F, 9.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r9 = head
				.addOrReplaceChild("cube_r9",
						CubeListBuilder.create().texOffs(0, 32).addBox(-3.0F, -10.0F, 6.0F, 11.0F, 7.0F, 0.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r10 = head
				.addOrReplaceChild("cube_r10",
						CubeListBuilder.create().texOffs(26, 28).addBox(-6.0F, -10.0F, 3.0F, 12.0F, 7.0F, 0.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F));

		PartDefinition cube_r11 = head
				.addOrReplaceChild("cube_r11",
						CubeListBuilder.create().texOffs(0, 39).addBox(-8.0F, -10.0F, 6.0F, 11.0F, 7.0F, 0.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r12 = head.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(26, 35)
						.addBox(-6.0F, -10.0F, 8.0F, 12.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
