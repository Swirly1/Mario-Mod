...
public class Modeltoad<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rightFoot = partdefinition.addOrReplaceChild("rightFoot", CubeListBuilder.create()
				.texOffs(62, 63).addBox(-5.0F, -2.0F, -3.0F, 3.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition leftFoot = partdefinition.addOrReplaceChild("leftFoot", CubeListBuilder.create().texOffs(44, 63)
				.addBox(2.0F, -2.0F, -3.0F, 3.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(62, 49)
						.addBox(-3.0F, -3.0F, -3.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(22, 62)
		...
		PartDefinition cube_r1 = body
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(54, 8).addBox(-5.0F, 6.5F, -3.0F, 10.0F, 1.0F, 6.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, -3.5F, 0.0F, 3.1416F, 0.0F, 0.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 58)
						.addBox(-4.0F, 4.0F, -3.0F, 8.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(46, 26)
						...
						.addBox(-8.0F, 10.0F, -5.0F, 16.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(42, 37)
						.addBox(-7.0F, 11.0F, -5.0F, 14.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 11.0F, 0.0F, 3.1416F, 0.0F, 0.0F));

		PartDefinition cube_r2 = head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-10.0F, 5.0F, -5.0F, 20.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(46, 15)
						.addBox(-7.0F, 10.0F, -5.0F, 14.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(0, 25)
						.addBox(-9.0F, 9.0F, -5.0F, 18.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 14.0F, 0.0F, 3.1416F, 0.0F, 0.0F));

		PartDefinition cube_r3 = head.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(56, 56)
						.addBox(-4.0F, 0.0F, -3.0F, 8.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(36, 48)
		...
		PartDefinition cube_r4 = leftarm.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 16)
						.addBox(1.25F, -0.5F, 1.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 18)
						...
						.addBox(1.25F, 1.25F, -2.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(12, 69)
						.addBox(-2.5F, 0.0F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = rightarm.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(1.25F, -0.5F, 1.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 2)
						...
						.addBox(1.25F, 1.25F, 1.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 65)
						.addBox(-2.5F, 0.0F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(8.0F, -8.0F, 0.0F, 0.0F, 0.0F, 0.6545F));
